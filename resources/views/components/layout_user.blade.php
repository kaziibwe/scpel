...
<body class="h-screen flex flex-col gap-5" style="text-align: justify; text-justify: inter-word;">
    <nav
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            {{-- <img src="/scpel_logo.png"> --}}
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">

                    @auth
                    <!-- Display this content if the user is authenticated -->
                ...
                {{-- <img src="https://ui-avatars.com/api/?name={{  }}&background=random" alt="" srcset=""> --}}
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Scpel -
                        Crafting
                        Intelligence...</span>
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#"
                    class="hover:underline">Scpel™</a>. All Rights Reserved.
            </span>
