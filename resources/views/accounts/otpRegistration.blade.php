...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../cdns/flowbite.min.css">
    <link rel="stylesheet" href="../cdns/tailwind.min.css">
    <link rel="stylesheet" href="../sheety.css"/>
  </head>
  <body class="h-screen flex flex-col gap-5" style="text-align: justify; text-justify: inter-word;"> <u></u>
    {{-- @dd($email); --}}
      ...
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul
            ...
            <li>
              <a href="scpel_getting_started.html"
      ...
      <div  class=" w-full mt-20">
        <div class="w-full">
          <div class="header bg-transparent items-center">
              ...
              <form method="POST" action="{{ route('user.otpverify',$email) }}">
                @csrf
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Comfirm Email:   <b><a href="{{ route('sendMail',$email) }}">resend OTP</a></b></label>
                  <input type="text" name='velification_code' value="{{ old('velification_code') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="OTP expires in 24 hours - 000000">
                  @error('velification_code')
                   {{ $message }}
                  @enderror
                  <div class="mt-10 flex flex-col">
                    <!-- Full-width button below the first two buttons -->
                    <button type="submit" class="w-full py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"> Complete Registration</button>
                  </div>
              </form>
  ...
  <footer class="bg-white dark:bg-gray-900 bottom-0 mt-auto">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Scpel - Crafting Intelligence...</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Research</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Toolchains</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" class="hover:underline">Nervous</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Scpel™</a>. All Rights Reserved.
          </span>
    ...
    <script src="cdns/flowbite.min.js"></script>
